(function (){
    ...
    // 「希望日」が変更された時に実行
    collaboflow.events.on('request.input.fid116.change',function(data){

        if (data.parts.fid116.value != "" && data.parts.fid116.value != null) {
            ...
            // 希望日
            var kiboubi = new Date(data.parts.fid116.value);
            ...
            if (selectedDay === 0 || selectedDay === 6) {
                ...
                data.parts.fid116.value = "";
                data.parts.fid116.focus();
                return false;
            }
